export default {
  ...
  FaceTec_accessibility_tap_guidance:
    'Tippen Sie für Hilfe zur Positionierung Ihres Gesichts doppelt auf eine beliebige Stelle des Bildschirms.',
  FaceTec_accessibility_key_down_guidance:
    'Drücken Sie die Eingabetaste oder die Leertaste, um eine Anleitung zur Gesichtsausrichtung zu erhalten',

  FaceTec_accessibility_feedback_move_phone_away: 'Ihr Gesicht ist zu nah',
  FaceTec_accessibility_feedback_move_phone_closer:
    'Ihr Gesicht ist zu weit entfernt',
  FaceTec_accessibility_feedback_face_too_far_left:
    'Ihr Gesicht ist zu weit links',
  FaceTec_accessibility_feedback_face_too_far_right:
    'Ihr Gesicht ist zu weit rechts',
  ...
  FaceTec_accessibility_feedback_hold_to_eye_level_web:
    'Bewegen Sie die Kamera auf Augenhöhe',
  ...
  FaceTec_feedback_move_web_closer:
    'Bringe das Gesicht näher und fülle das Oval aus',
  ...
  FaceTec_feedback_use_even_lighting:
    'Leuchten Sie Ihr Gesicht gleichmäßiger aus',

  FaceTec_instructions_header_ready_desktop:
    'Bereiten Sie sich auf Ihr Video-Selfie vor',
  ...
  FaceTec_instructions_message_ready_desktop:
    'Bringe dein Gesicht ins Oval, drücke „Ich bin bereit“ und rücke näher ran',
  FaceTec_instructions_message_ready_1_mobile:
    'Positionieren Sie Ihr Gesicht im Oval',
  FaceTec_instructions_message_ready_2_mobile:
    'Drücke „Ich bin bereit“ und rücke näher ran',
  ...
  FaceTec_camera_feed_issue_header_mobile:
    'Problem durch Schutz<br/>der Kameraverbindung',
  FaceTec_camera_feed_issue_subheader_message_mobile:
    "Diese Anwendung blockiert verdächtige Webkonfigurationen.<br/><a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Weitere Informationen</a>.",
  FaceTec_camera_feed_issue_subheader_message:
    'Dieses System kann aufgrund Folgendes nicht verifiziert werden:',
  ...
  FaceTec_camera_feed_issue_table_row_1_cell_1_firefox_permissions_error:
    'Die Kammer erlaubt in Firefox nicht erinnert.',
  FaceTec_camera_feed_issue_table_row_1_cell_2_firefox_permissions_error:
    'Mark erinnern Sie sich die Berechtigungen.',
  FaceTec_camera_feed_issue_table_row_1_cell_1:
    'Kammer bereits von einer anderen Anwendung verwendet.',
  FaceTec_camera_feed_issue_table_row_1_cell_2:
    'Schließen Sie die andere Anwendung.',
  FaceTec_camera_feed_issue_table_row_2_cell_1:
    'Eine Anwendung des 3. Parks ändert das Video.',
  FaceTec_camera_feed_issue_table_row_2_cell_2:
    'Die andere Anwendung schließen / deinstallieren.',
  FaceTec_camera_feed_issue_table_row_3_cell_1:
    'Geräte, die nicht geschützt werden können.',
  FaceTec_camera_feed_issue_table_row_3_cell_2:
    'Verwenden Sie ein anderes Gerät.',
  FaceTec_camera_feed_issue_subtable_message:
    "Diese Anwendung blockiert verdächtige Webkonfigurationen. <a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Weitere Informationen</a>.",
  ...
  FaceTec_camera_permission_message:
    'Kameraberechtigungen deaktiviert.<br/>Überprüfen Sie die Einstellungen Ihres Betriebssystems und Browsers',

  FaceTec_enter_fullscreen_header: 'Vollbild-Selfie-Modus',
  FaceTec_enter_fullscreen_message:
    'Bevor wir beginnen, klicken Sie bitte auf die Schaltfläche unten, um den Vollbildmodus zu öffnen.',

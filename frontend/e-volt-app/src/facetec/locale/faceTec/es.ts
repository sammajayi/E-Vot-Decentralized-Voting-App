export default {
  ...
  FaceTec_accessibility_feedback_move_phone_closer:
    'Su rostro está demasiado lejos',
  ...
  FaceTec_accessibility_feedback_face_too_high:
    'Su rostro está demasiado arriba',
  ...
  FaceTec_accessibility_feedback_face_not_in_camera:
    'El rostro no se ve en la cámara o está demasiado lejos',
  ...
  FaceTec_instructions_message_ready_2_mobile:
    'Presione "Estoy listo" y acérquese',
  ...
  FaceTec_camera_feed_issue_header:
    'Problema al proteger la conexión de la cámara',
  ...
  FaceTec_camera_feed_issue_subheader_message_mobile:
    "Esta aplicación bloquea configuraciones de cámara web sospechosas.<br/><a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Aprende más aquí.</a>.",
  ...
  FaceTec_camera_feed_issue_table_row_1_cell_1:
    'Cámara ya en uso por otra aplicación.',
  ...
  FaceTec_camera_feed_issue_table_row_2_cell_2:
    'Cierre / desinstale la otra aplicación.',
  FaceTec_camera_feed_issue_table_row_3_cell_1:
    'Equipos que no pueden ser protegidos.',
  FaceTec_camera_feed_issue_table_row_3_cell_2: 'Usa un dispositivo diferente.',
  FaceTec_camera_feed_issue_subtable_message:
    "Esta aplicación bloquea configuraciones de cámara web sospechosas. <a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Aprende más aquí.</a>.",
  ...
  FaceTec_camera_permission_message:
    'Permisos de cámara deshabilitados.<br/>Verifique la configuración de su sistema operativo y navegador',
  ...
  FaceTec_result_idscan_success_passport_message:
    'Escaneo de pasaporte completado',

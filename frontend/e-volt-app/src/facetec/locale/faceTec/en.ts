export default {
  ...
  FaceTec_instructions_message_ready_desktop:
    "Frame Your Face in the Oval, Press I'm Ready & Move Closer",
  ...
  FaceTec_camera_feed_issue_subheader_message_mobile:
    "This App blocks suspicious webcam configurations.<br/><a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Learn More Here</a>.",
  ...
  FaceTec_camera_feed_issue_subtable_message:
    "This App blocks suspicious webcam configurations. <a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Learn More Here</a>.",
  ...
  FaceTec_camera_permission_message:
    'Camera permissions disabled.<br/>Please check your operating system and browser settings.',
  ...
  FaceTec_result_facescan_upload_message:
    'Uploading<br/>Encrypted<br/>3D FaceScan',
  ...
  FaceTec_result_idscan_retry_barcode_not_read_message:
    'Barcode Failed To Scan<br/>Please Try Again',
}

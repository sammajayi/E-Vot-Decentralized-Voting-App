      ...
      <div className="w-[34rem] h-[79vh] border rounded-lg p-6 py-10">
        ...
        <form className="mt-10">
          ...
          <div class="flex space-x-4 pt-5 ml-2 form-item">
            ...
            <button onClick={() => setOpen(true)} className="bg-[#9747FF] text-white w-[12.9rem] h-[2.6rem] rounded-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
              Proceed
            </button>
          </div>
        </form>
